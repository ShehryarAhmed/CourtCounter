...
public final class QueryUtils {
    ...
    public static final String SAMPLE_JSON_RESPONSE = "http://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&orderby=time&minmag=6&limit=10";
...
*/
     ...
     */
    public static List<customclass> extractFeatureFromJson(String earthQuakJson) {
...
// Get a single earthquake at position i within the list of earthQuakes
    ...
    public static List<customclass> fetchEarthquakeData(String requestUrl) {
        ...
        List<customclass> earthquakes = extractFeatureFromJson(jsonResponse);
