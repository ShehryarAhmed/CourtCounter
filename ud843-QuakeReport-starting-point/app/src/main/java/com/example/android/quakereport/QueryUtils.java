...
public final class QueryUtils {
     ...
     */
    public static ArrayList<customclass> extractEarthquakes() {

        SimpleDateFormat dateFormat = new SimpleDateFormat("MMM DD,yyyy h:mm a", Locale.ENGLISH);

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<customclass> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONObject basejsonrespo = new JSONObject(SAMPLE_JSON_RESPONSE);
